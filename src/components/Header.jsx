...
function Header() {
  ...
  const textMutedColor =
    !isHomePage || isScrolled ? "text-dark/60" : "text-cream/80";

  return (
    <>
      <header
        className={`fixed top-0 left-0 w-full z-100 transition-all duration-500 border-b ${headerBg}`}
      >
          ...
          <div className="flex items-center gap-4 md:gap-6">
            <div className="relative hidden lg:block">
              ...
              >
                ...
                <ChevronDown
                  size={14}
                  className={`transition-transform duration-300 ${showLang ? "rotate-180" : ""}`}
                />
              </button>
              {showLang && (
                <div
      ...
      >
        ...
        <div className="mobile-nav-el flex flex-col items-center gap-4 border-t border-white/10 pt-8 w-40">
          <p className="text-gold text-[10px] tracking-[0.3em] uppercase font-bold">
            Language
          </p>
