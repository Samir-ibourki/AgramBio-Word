      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex justify-center mb-20 animate-fade-in">
          <Link to="/" className="group flex flex-col items-center">
            <span className="text-3xl md:text-4xl font-serif font-black  tracking-tighter text-dark text-center">
              Agram<span className="text-gold"> Souss</span>
            </span>
            <div className="w-8 h-px bg-gold/30 mt-2 group-hover:w-16 transition-all duration-700" />
          </Link>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-16 md:gap-8 mb-10 max-w-5xl mx-auto px-4 md:px-0">
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-4">
              <li className="text-[17px] text-dark/50 font-serif  lowercase hover:text-gold transition-colors">
                <a href={`mailto:${BOUTIQUE_INFO.email}`}>
                  {BOUTIQUE_INFO.email}
                </a>
              </li>
              <li className="text-[16px] text-dark/50 font-serif ">
        ...
        <div className="flex justify-center items-center gap-6 mb-6 border-t border-black/5 pt-12">
          {LANGUAGES.map((lang) => (
            <button
              ...
              className={`text-[12px] tracking-widest transition-all duration-300 cursor-pointer ${
                i18n.language === lang.code
                  ? "font-black text-dark underline underline-offset-8"
                  : "text-dark/40 hover:text-gold"
              }`}
            >
              {lang.label}
            </button>
