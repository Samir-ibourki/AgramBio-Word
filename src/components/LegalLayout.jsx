...
function LegalLayout({ title, children }) {
  ...
  useGSAP(() => {
    gsap.from(".legal-header", { y: 30, opacity: 0, duration: 1, ease: "power3.out" });
    gsap.from(".legal-content", { y: 50, opacity: 0, duration: 1, delay: 0.2, ease: "power3.out" });
  }, { scope: containerRef });
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="legal-header mb-16">
          ...
          >
            ...
            <span className="text-[10px] uppercase font-bold tracking-[0.2em]">{t('product_detail.back')}</span>
          </Link>
          ...
          <div className="space-y-4">
            ...
            <div className="w-12 h-[2px] bg-gold/30 mt-8" />
          </div>
        </div>

        {/* Content Section */}
        <div className="legal-content bg-white border border-black/5 rounded-[40px] p-8 md:p-16 shadow-sm shadow-dark/[0.02]">
        ...
        <div className="mt-12 text-center">
            <Link to="/contact" className="text-[11px] uppercase font-bold tracking-[0.2em] text-dark/40 hover:text-gold transition-colors">
