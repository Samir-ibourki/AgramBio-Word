            ...
            <ul className="space-y-6">
              {["why_1", "why_2", "why_3", "why_4"].map((key, i) => (
                <li key={i} className="flex gap-4 items-center group">
                  ...
                  <span className="text-dark/70 font-medium group-hover:text-gold transition-colors">
                    {t(`about.${key}`)}
                  </span>
                </li>
              ))}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="space-y-2">
                <div className="text-gold/40 flex justify-center">
                  {item.icon}
                </div>
                <p className="text-[0.7rem] uppercase font-black tracking-widest  text-dark/30">
                  {t(item.labelKey)}
                </p>
              </div>
            ))}
