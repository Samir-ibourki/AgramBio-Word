  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-4xl w-full">
        ...
        <div
          ref={dividerRef}
          className="w-25 h-px bg-linear-to-r from-transparent via-gold to-transparent my-8 mx-auto"
        />
        ...
        <div ref={btnsRef} className="flex flex-wrap gap-4 justify-center">
          <Link to="/shop" className="cursor-pointer px-10 py-4 bg-gold text-black shadow-[0_10px_30px_rgba(0,0,0,0.25)] font-bold tracking-widest text-xs md:text-sm rounded-full hover:bg-white hover:text-dark hover:shadow-[0_20px_40px_rgba(0,0,0,0.15)] transition-all duration-300 ease-out">
            {t("hero.shop_now")}
          </Link>
          <Link to="/about" className="cursor-pointer px-10 py-4 border border-white/30 text-white backdrop-blur-md bg-white/5 font-bold tracking-widest text-xs md:text-sm rounded-full hover:bg-gold/10 transition-all duration-300 ease-out">
