...
function Features() {
  ...
  return (
    <section
      ref={containerRef}
      className="py-16 md:py-24 bg-white border-y border-black/5 overflow-hidden"
    >
          ...
          {FEATURES_DATA.map((feature, index) => (
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p
                  className="text-dark/40 text-[13px]  tracking-widest font-semibold
 leading-relaxed max-w-50 mx-auto lg:text-[0.8rem]"
                >
                  {t(feature.descKey)}
                </p>
              </div>
